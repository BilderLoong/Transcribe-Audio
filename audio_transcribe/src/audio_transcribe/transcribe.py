...
def transcribe_by_whisper_ctranslate2(
    ...
    # whisper-ctranslate2 --threads 32 --initial_prompt "Use punctuation." --word_timestamp True --model large-v2 --verbose True  --highlight_words True "銃・病原菌・鉄 上/003 - 銃・病原菌・鉄 上.mp3"
